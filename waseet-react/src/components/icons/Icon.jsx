...
/**
 * Feather-style stroked icon set used across Waseet.
 * Each entry is the inner SVG markup for a 24x24 viewBox.
 * Usage: <Icon name="mail" size={14} color="#9CA3AF" strokeWidth={1.7} />
 */
const paths = {
  mapPin: (
    <>
  ...
  eyeOff: (
    <path d="M2 2l20 20M6.7 6.7C4 8.4 2 12 2 12s3.5 7 10 7c2 0 3.7-.6 5.2-1.4M9.9 4.2A9.7 9.7 0 0 1 12 4c6.5 0 10 7 10 7a16 16 0 0 1-2.3 3.2" />
  ),
  clock: (
    <>
...
export function Icon({ name, size = 16, color = 'currentColor', strokeWidth = 1.7, style, fill = 'none', ...rest }) {
